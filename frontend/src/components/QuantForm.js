...
class QuantForm extends React.Component {
  ...
  authorizeQuant(){
    thisContract.approve.sendTransaction("0x74814602062af64fd7a83155645ddb265598220e", 1000,{
  ...
  render() {
    return (
      <div>
        ...
        >
          <DialogTitle id="form-dialog-title">Purchase & Authorize</DialogTitle>
          <DialogContent>
            <DialogContentText>
              Purchase some Quantstamps
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
          ...
          <DialogContent>
            <DialogContentText>
              Authorize Quantstamps to take X tokens
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
