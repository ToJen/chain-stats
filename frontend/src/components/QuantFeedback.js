  ...
  constructor() {
    ...
    this.state = {
      feedback: {
        ...
        contract_uri:
          'https://s3.amazonaws.com/qsp-protocol-test-contracts/abc9341dcce-b5e3-418b-9c00-167e0df73eaa.sol',
        contract_hash:
          '90b555f2ef5327e1896001d87462e2e69da3daace18cb7b60f22312493a9c4f9',
        ...
        analyzers_reports: [
          {
            analyzer: {
              name: 'oyente',
              version:
                '16c74d21e997cffe9a7480cb140ee6c05b7ba608e1b878df90f585b4710e41b0',
              ...
              command:
                'python /oyente/oyente/oyente.py -ce -j -s /shared/tmp4eqkpx7r',
            },
            status: 'success',
            warnings: [
            ...
            hash:
              '5a6540317a07769c1a3b665a2a42029042545d38093a081d86db51b7a05f4782',
          ...
          },
          {
            analyzer: {
              name: 'mythril',
              version:
                'a4e01e358fc52517a1889fad415846876d27ad9e8f6555a59246b761a89ec882',
              vulnerabilities_checked: [
                'call_data_forwarded',
              ...
              command:
                'docker run -v "/tmp/mythril/821":/shared/ -i "mythril/myth@sha256:a4e01e358fc52517a1889fad415846876d27ad9e8f6555a59246b761a89ec882" -o json -x "/shared/tmp4eqkpx7r"',
            },
            status: 'success',
            potential_vulnerabilities: [
              {
            ...
            hash:
              '37bc69a8da1473c5c79a5c279cf8df9b5cca0104a55d60e5b550bfee37c04c27',
            start_time: 1532093121,
            end_time: 1532093127,
          },
        ],
  ...
  loadVulnerabilities() {
    ...
    for (var report in reports) {
      for (var vuls in reports[report]['potential_vulnerabilities']) {
        ...
        var vulDescription =
          reports[report]['potential_vulnerabilities'][vuls]['description']
        ...
        <ExpansionPanel>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.heading}>
              {this.state.vulnerabilities[0].name}
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>{this.state.vulnerabilities[0].description}</Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.heading}>
              {this.state.vulnerabilities[1].name}
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>{this.state.vulnerabilities[1].description}</Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.heading}>
              {this.state.vulnerabilities[2].name}
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>{this.state.vulnerabilities[2].description}</Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.heading}>
              {this.state.vulnerabilities[3].name}
            </Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>{this.state.vulnerabilities[3].description}</Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
      </div>
    )
